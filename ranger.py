###############################################################
## Source: https://github.com/lessw2020/Ranger-Deep-Learning-Optimizer/blob/master/ranger.py
## This source use code from these soures:
...
class Ranger(Optimizer):
    """ A combination of two optimizer that is very new at the moment of writing, LookAhead and Radam.
    """
